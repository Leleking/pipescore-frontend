        ...
        <div>
            <ul class="site-menu" data-plugin="menu">
                <li class="site-menu-item ">
                    <a @click.prevent="openUp('/admin/dashboard')">
                ...
                <li class="site-menu-item">
                    <a @click.prevent="openUp('/admin/dashboard')">
                        <i class="site-menu-icon md-account-calendar" aria-hidden="true"></i>
                ...
                <li class="site-menu-item">
                    <a @click.prevent="openUp('/admin/dashboard')">
                        ...
                        <span class="site-menu-title">My Files</span>
                    </a>
                </li>
                <li class="site-menu-item">
                    <a @click.prevent="openUp('/admin/courses')">
                        <i class="site-menu-icon md-cloud" aria-hidden="true"></i>
                        <span class="site-menu-title">My courses</span>
                    </a>
                </li>
                <li class="site-menu-item">
                    <a @click.prevent="openUp('/admin/students')">
