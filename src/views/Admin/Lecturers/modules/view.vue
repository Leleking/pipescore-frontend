            ...
            <div class="panel-body">
                <div class=" ">
                    ...
                    <div class="example-wrap">
                        <h4 class="example-title">Lecturer: {{lecturer.name}}</h4>
                        <p>
                    ...
                    <div class="example">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 form-control-label"><strong>Lecturer Name</strong> </label>
                             <div class="col-md-9">
                                <div class="row">
                                    <div class="col-md-4">
                                        <input v-validate="'required'" disabled name="first name"  type="text" v-model="lecturer.fname" class="form-control" placeholder="First Name"  autocomplete="off"
                                        />
                                            <span style="color: #D8000C"><small>{{ errors.first('first name') }}</small></span>

                                    </div>
                                    <div class="col-md-4">
                                        <input v-validate="'required'" disabled name="last name"  type="text" v-model="lecturer.lname" class="form-control" placeholder="Last Name"  autocomplete="off"
                                        />
                                            <span style="color: #D8000C"><small>{{ errors.first('last name') }}</small></span>

                                    </div>
                                    <div class="col-md-4">
                                        <input name="other name" disabled type="text" v-model="lecturer.oname" class="form-control" placeholder="Other Name"  autocomplete="off"
                                        />
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                            <input v-validate="'required'" type="text" disabled v-model="lecturer.email" class="form-control" name="email"  autocomplete="off"
                            />
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                            <input v-validate="'required'" disabled type="text" v-model="lecturer.phone" class="form-control" name="phone"  autocomplete="off"
                            />
        ...
        <div class="panel" id="exampleReport">
            <div class="panel-body">
                <div class=" ">
                    ...
                    <!-- Example Horizontal Form -->
                    <div class="example-wrap">
                        <h4 class="example-title">Courses Assigned to {{lecturer.name}}</h4>
                        <p>
                            Lecturers will be informed immediately their info is changed
                        </p>
                    <div class="example">
