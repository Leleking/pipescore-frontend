<template>
    <div>
        <div class="page-header page-header-bordered">
           ...
           <!--  <h1 class="page-title" style="float:left">Lectuerers</h1> -->
                ...
                <div class="panel-body">
                    <div class=" ">
                        ...
                        <div class="example-wrap">
                            ...
                            <p>
                                Lecturers will be informed immediately they are added to Papermap
                            </p>
                        <div class="example">
                            ...
                            <div class="form-group row">
                                ...
                                <button type="button" @click.prevent="addLecturer" class="btn btn-primary">Submit </button>
            ...
            addLecturer() {
                ...
                .then(() => {
                    if(!this.errors.any()) {
                        ...
                        Crud.add('lecturers',this.lecturer)
                        .then(({data}) => {
                            this.$store.dispatch('setLoading',false)
                            //this.$router.push({name: "View Course",params: {id:data.id}})
                           
                            this.$snotify.success("Lecturer Added")
                        })
                        .catch((err) => {
