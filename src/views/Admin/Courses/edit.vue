                ...
                <div class=" ">
                    ...
                    <div class="example">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="avatar-upload">
                                    ...
                                    <div class="avatar-preview">
                                        ...
                                        <div v-if="course.image == 'default.jpg'" id="imagePreview" :style="{'background-image': `url(${url})`}"></div>
                                        <div v-else id="imagePreview" :style="{'background-image': `url(${url})`}"></div>
                                    </div>
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <button type="button" @click.prevent="editCourse" class="btn btn-primary">Update </button>
    ...
    export default {
        ...
        methods: {
            ...
            async getCourse() {
                ...
                try {
                    var course = await CrudService.show('courses',this.$route.params.id)
                    this.course = course.data
                    this.url = this.apiDomain + "/" + this.course.image 
                } catch (error) {
                    console.log(error)
                }
            ...
            editCourse() {
                ...
                .then(() => {
                    if(!this.errors.any()) {
                        this.$store.dispatch('setLoading',true)
                        CrudService.update('courses',this.course,this.$route.params.id)
                        .then((response) => {
                            this.$store.dispatch('setLoading',false)
                            this.$router.go(-1)
