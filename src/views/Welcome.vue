    ...
    <div>
        ...
        <section id="hero" class="d-flex align-items-center">
            ...
            <div class="row">
                ...
                <h1>Media monitoring made easy</h1>
                <ul>
                    <li><i class="ri-check-line"></i> Online reputation management made easy</li>
                    <li><i class="ri-check-line"></i> Tracking your competition made easy</li>
                    <li><i class="ri-check-line"></i>Get instant access to brand mentions across social, news, blogs, videos, forums, reviews and more.</li>
                </ul>
                <div class="mt-3">
                    <a href="#about" class="btn-get-started scrollto">Get Started</a>
                    <a @click.prevent="route('/auth/login')" class="btn-get-quote">Login</a>
                </div>
                </div>
                <div class="col-lg-6 order-1 order-lg-2 hero-img">
                <img src="assets/img/like-share.jpg" class="img-fluid" alt="">
                </div>
            </div>
            </div>
